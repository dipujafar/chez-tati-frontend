...
const TermsContainer = () => {
    return (
        ...
        <p className="text-primary-gray max-w-7xl">
        ...
        <h1 className="text-6xl font-bold mb-10">→ Scope of Service</h1>
        <div>
          <p className="text-primary-gray max-w-7xl mb-5">
        ...
        <h1 className="text-6xl font-bold mb-10">→ Copyright and Ownership</h1>
        <div>
          <p className="text-primary-gray max-w-7xl mb-5">
